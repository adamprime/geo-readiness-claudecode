---
description: Run a GEO readiness audit on the current project or a live URL
argument-hint: [url]
...
Before starting, read the detailed methodology and scoring criteria in the co-located `references/methodology.md` file. Check `~/.claude/commands/geo/references/methodology.md` (personal install) or `.claude/commands/geo/references/methodology.md` (project install).
